       ...
       public async Task<IActionResult> Proceder()
        {
            ...
            carroCompraVM.Orden.Direccion = carroCompraVM.Orden.UsuarioAplicacion.Direcion;
        ...
        public async Task<IActionResult> Proceder(CarroCompraVM carroCompraVM)
        {
            ...
            foreach (var lista in carroCompraVM.CarroCompraLista)
            {
                var sessionLineItem = new SessionLineItemOptions
                {
                    ...
                    {
                        UnitAmount = (long)(lista.Precio * 100),  // Q20  => 200
                        //UnitAmount = (long)(lista.Precio),  // Q20  => 200
                        Currency = "gtq",
